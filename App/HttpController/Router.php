...
class Router extends \EasySwoole\Core\Http\AbstractInterface\Router
{
    ...
    public function register(RouteCollector $routeCollector)
    {
        ...
        $routeCollector->addRoute('GET', '/api/users/{id}', '/api/users/index');
        ...
        $routeCollector->addRoute('POST', '/api/events/{id}/actions/reserve', '/api/events/actions/reserve');
        ...
        $routeCollector->addRoute('DELETE', '/api/events/{id}/sheets/{ranks}/{num}/reservation', '/api/events/actions/reservation');
        ...
        $routeCollector->addRoute('GET', '/admin/api/events', '/admin/api/events/index');
        ...
        $routeCollector->addRoute('POST', '/admin/api/events', '/admin/api/events/new');
        ...
        $routeCollector->addRoute('GET', '/admin/api/events/{id}', '/admin/api/events/detail');
        ...
        $routeCollector->addRoute('POST', '/admin/api/events/{id}/actions/edit', '/admin/api/events/actions/edit');
        ...
        $routeCollector->addRoute('GET', '/admin/api/reports/events/{id}/sales', '/admin/api/events/detailSales');
        ...
        $routeCollector->addRoute('GET', '/admin/api/reports/sales', '/admin/api/events/sales');
